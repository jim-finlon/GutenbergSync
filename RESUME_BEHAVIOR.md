...
- `--archive` (-a): Preserves file attributes, enables incremental sync and delta-transfer
...
- **Delta-transfer algorithm**: rsync's built-in smart resume (compares checksums, only transfers missing parts)
